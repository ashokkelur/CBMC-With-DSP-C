...
Function: configt::ansi_ct::dsp_c

  Inputs:

 Outputs:

 Purpose: int=16, long=32, pointer=32, char=2

\*******************************************************************/

void configt::ansi_ct::dsp_c()
{
  int_width=2*8;
  long_int_width=4*8;
  char_width=2*8;
  ...
  char_is_unsigned=true; // Check with this
  wchar_t_width=4*8;
  alignment=1;

  // DSP-C specific
  short_fixed_width = 2 * 8;
  fixed_width       = 4 * 8;
  short_accum_width = 3 * 8;
  accum_width       = 5 * 8;
